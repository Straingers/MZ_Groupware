                ...
                <div class="card-header card-header-tabs-line p-2">
                    <div class="card-toolbar">
                        <ul class="nav nav-tabs nav-bold nav-tabs-line">
                            <li class="nav-item" onclick="parent.goPage('approval/lib/req/list.do','M020100');">
                                <a class="nav-link <c:if test="${pageType eq 'req'}">active</c:if>" data-toggle="tab" href="#">
                                    <span class="nav-icon"><i class="fas fa-tasks"></i></span>
                                    <span class="nav-text">상신함</span>
                                </a>
                            </li>
                            <li class="nav-item" onclick="parent.goPage('approval/lib/rej/list.do','M020100');">
                                <a class="nav-link <c:if test="${pageType eq 'rej'}">active</c:if>" data-toggle="tab" href="#">
                                    <span class="nav-icon"><i class="fas fa-file-import"></i></span>
                                    <span class="nav-text">반려함</span>
                                </a>
                            </li>
                        </ul>
                    </div>
						...
						<table class="table">
							...
							<tbody>
								...
								<tr onclick="OpenWindow('detail.do?appNo=${approval.appNo}','','1000','700');" style="cursor: pointer;">
									...
									<td class="text-center align-middle">${approval.appStatus }</td>
								</tr>
								</c:forEach>
							</tbody>
						</table>
