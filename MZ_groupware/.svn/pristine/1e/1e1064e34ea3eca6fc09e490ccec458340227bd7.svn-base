									...
									<tr>
										...
										<td class="p-0 align-middle text-center">
											<c:if test="${resultBean.taskReceiverType eq 'cc'}">
												<span class="label font-weight-bolder label-rounded label-light-danger" style="width: 35px;">참조</span>
											</c:if>
											<c:if test="${resultBean.taskReceiverType eq 'rec'}">
												<span class="label font-weight-bolder label-rounded label-light-primary" style="width: 35px;">수신</span>
											</c:if>
										</td>
