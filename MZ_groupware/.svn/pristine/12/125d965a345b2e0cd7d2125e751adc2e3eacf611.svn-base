            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <div class="card-body">
                    <form enctype="multipart/form-data" method="post" name="modifyForm">
                    	<input type="hidden" name="pdsNo" id="pdsNo" value="${pds.pdsNo }">
                        <div class="form-group row">
                            <label for="title" class="col-2 col-form-label text-center">제목</label>
                            <div class="col-10">
                                <input id="title" name="title" type="text" class="form-control" value="${pds.title }"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-2 col-form-label text-center">작성자</label>
                            <div class="col-10">
		                        <div class="form-control" style="display: flex;align-items: center;font-weight: bold;" readonly>${pds.empName}</div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-12">
                               	<div class="summernote" id="kt_summernote_1">${pds.content }</div>
                            	...
                            	<c:forEach items="${pds.attachList}" var="attach">
									<div class="inputRow attach-item">
										<a class="text-dark text-hover-primary mb-1 font-size-lg" 
											...
											href="<%=request.getContextPath()%>/office/pds/getFiles.do?attachNo=${attach.attachNo}" >
