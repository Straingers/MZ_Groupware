			...
			<div class="card card-custom gutter-b example example-compact" style="height:100%">
				<div class="card-header flex-wrap border-0 pt-6 pb-0">
					<div class="card-title">
						<button class="btn btn-primary font-weight-bolder" onclick="javascript:OpenWindow('<%=request.getContextPath()%>/board/anony/registForm.do','게시글 등록',800,700);">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-dark text-hover-primary mb-1" style="text-align: left; color: #007bff; cursor:pointer;"
										onclick="javascript:OpenWindow('<%=request.getContextPath()%>/board/anony/detail.do?commNo=${communityBoard.commNo}','상세보기',800,700);">
