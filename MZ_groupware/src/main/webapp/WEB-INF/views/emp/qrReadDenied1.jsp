...
<div class="error">
  <div class="error__title">Access Denied</div>
  <div class="error__subtitle">귀하의 IP는 접속이 허용되지 않습니다.</div>
  <div class="error__description">출/퇴근 체크 페이지에 접속하고 싶으시면 운영 관리자에게 문의바랍니다.</div>
  <a class="error__button error__button--active" href="/mz">MAIN PAGE</a>
</div>
