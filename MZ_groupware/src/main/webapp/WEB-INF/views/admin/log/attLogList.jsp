            ...
            <div class="card card-custom" style="height:100%">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="d-flex justify-content-between mt-3 mb-6">
                    	<button class="btn btn-primary font-weight-bolder btn-sm" onclick="remove_file();">
	                        첨부파일 정리
	                    </button>
						...
						<table class="table">
							<thead>
								<tr>
									...
									<th class="text-center" style="width: 300px;">게시위치</th>
									<th class="text-center" style="width: 80px;">삭제여부</th>
							...
							<tbody>
								<c:forEach items="${dataMap.attList}" var="att">
									<tr>
										<td class="text-center align-middle">${att.attachNo}</td>
										<td class="align-middle">
											<span class="font-weight-bolder">[</span><span style="color:#0871b9">${att.menuName}</span><span class="font-weight-bolder">]&nbsp;</span>${att.commTitle}
										</td>
										<td class="text-center align-middle">${att.isDel}</td>
										<td class="align-middle">${att.fileName}</td>
										<td class="text-center align-middle" data-toggle="tooltip" data-placement="bottom" title="${att.deptName}&nbsp;${att.empName}&nbsp;${att.psName}(${att.attachAttacher})">
											${att.empName}
										</td>
										<td class="text-center align-middle">
											<fmt:formatDate value="${att.attachRegdate}" pattern="yyyy-MM-dd HH:mm"/>
										</td>
									</tr>
								</c:forEach>
							</tbody>
...
<script type="text/javascript">
	function remove_file() {
		location.href = "<%=request.getContextPath()%>/admin/log/attach/deleteFile.do";
	}
</script>
</body>
