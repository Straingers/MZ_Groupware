						...
						<table class="table">
							<thead>
								<tr>
									...
									<th class="text-center" style="width: 300px;">문서명</th>
							...
							<tbody>
								<c:forEach items="${dataMap.appList}" var="app">
									<tr>
										<td class="text-center align-middle">${app.attachNo}</td>
										<td class="align-middle">${app.appTitle }</td>
										<td class="align-middle">${app.fileName}</td>
										<td class="text-center align-middle" data-toggle="tooltip" data-placement="bottom" title="${app.deptName}&nbsp;${app.empName}&nbsp;${app.psName}(${app.attachAttacher})">
											${app.empName}
										</td>
										<td class="text-center align-middle">
											<fmt:formatDate value="${app.attachRegdate}" pattern="yyyy-MM-dd HH:mm"/>
										</td>
									</tr>
								</c:forEach>
							</tbody>
