            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        ...
                        <c:if test="${loginUser.empNo == pds.empNo }">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-10" style="display: flex;align-items: center;font-weight: bold;">${pds.title}</div>
                    </div>
                    <div class="form-group row">
                        <label for="empName" class="col-2 col-form-label text-center">작성자</label>
                        <div class="col-10" style="display: flex;align-items: center;font-weight: bold;">${pds.empName}</div>
                    </div>
                    <div class="form-group row">
                        <label for="regdate" class="col-2 col-form-label text-center">작성일</label>
                        <div class="col-10" style="display: flex;align-items: center;font-weight: bold;">${pds.regdate}</div>
                    </div>
                    ...
                    <div class="card card-custom gutter-b example example-compact">
						...
						<c:if test="${fn:length(pds.attachList) eq 0}">
							 <div class="card-body px-2 py-8 text-center">
									첨부파일이 없습니다.
							</div>
						</c:if>
						<c:if test="${fn:length(pds.attachList) gt 0}">
						<div class="card-body px-2 py-4">
							<c:forEach  items="${pds.attachList}" var="attach">
								<div class="col-sm-12" onclick="location.href='<%=request.getContextPath()%>/office/pds/getFiles.do?attachNo=${attach.attachNo}';">
...
<!--                     <div class="card card-custom gutter-b example example-compact"> -->
<!-- 						<div class="card-header"> -->
<!-- 							<h3 class="card-title">pdf뷰어</h3> -->
<!-- 						</div> -->
<!-- 						<div class="card-body"> -->
<%-- 							<iframe src="${attach.attachUploadpath}/${attach.uuidName}" style="width:700px;height:700px;"></iframe> --%>
<!-- 						</div> -->
<!-- 					</div>card -->
                </div>
            </div><!-- card-body -->
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" data-rno>
        <p><input type="text" id="taskReplytext" class="form-control" value="${pdsReplytext}"></p>
      </div>
...
<form role="form">
	<input type="hidden" id="pdsNo" name="pdsNo" value="${pds.pdsNo}"/>
	<input type="hidden" id="pdsReplyer" name="pdsReplyer" value=""/>
</form>
<script>
...
function remove_go() {
	$.ajax({
		url:"<%=request.getContextPath()%>/office/pds/remove.do"
		, type:"get"
		, data:{pdsNo:${pds.pdsNo}}
		, success:function(){
			Swal.fire({
			  	title: "삭제가  완료되었습니다.",
			  	icon: "success",
