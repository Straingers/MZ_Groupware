							...
							<tbody>
								...
								<c:forEach items="${dataMap.taskList}" var="resultBean" varStatus="i">
									...
									<td class="align-middle">
											<a class="text-dark text-hover-primary mb-1 font-size-lg" href="javascript:OpenWindow('<%=request.getContextPath()%>/task/share/modify.do?taskNo=${resultBean.taskNo}','업무공유 상세',1000,700);">
