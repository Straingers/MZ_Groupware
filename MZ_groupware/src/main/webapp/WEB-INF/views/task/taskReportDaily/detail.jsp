        ...
        <div class="container-fluid">
            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h3 class="card-title">일일보고 상세</h3>
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-10" style="display: flex;align-items: center;font-weight: bold;">
                        	<c:set var="sub" value="${task.taskSubtype}"/>
							<c:choose>
								<c:when test="${sub eq '일일보고'}">
									<span class="label label-lg font-weight-bolder label-rounded label-success mr-5" style=" width: 70px;">일일보고</span>
								</c:when>
								<c:when test="${sub eq '주간보고'}">
									<span class="label label-lg font-weight-bolder label-rounded label-primary mr-5" style=" width: 70px;">주간보고</span>
								</c:when>
								<c:when test="${sub eq '월간보고'}">
									<span class="label label-lg font-weight-bolder label-rounded label-warning mr-5" style=" width: 70px;">월간보고</span>
								</c:when>
							</c:choose>
                        	${task.taskTitle}
                       	</div>
