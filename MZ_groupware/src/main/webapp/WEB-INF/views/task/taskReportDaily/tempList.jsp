								...
								<c:forEach items="${dataMap.taskList}" var="resultBean" varStatus="i">
									<tr>
										...
										<td class="align-middle">
											<a class="text-dark text-hover-primary mb-1 font-size-lg" href="javascript:OpenWindow('<%=request.getContextPath()%>/task/daily/modify.do?taskNo=${resultBean.taskNo}','업무공유 상세',1000,700);">
